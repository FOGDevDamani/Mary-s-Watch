...
class RenterSignUpController: UIViewController, UITextFieldDelegate
{
  ...
  {
    guard let email = renterSignUpView.renterEmailTextField.text, renterSignUpView.renterEmailTextField.text?.count != 0, isValidEmail(emailID: email) != false  else
	{
    ...
    guard let password = renterSignUpView.renterPasswordTextField.text, renterSignUpView.renterPasswordTextField.text?.count != 0, isPasswordValid(password: password) != false else
	{
    ...
    guard let username = renterSignUpView.renterUsernameTextField.text, renterSignUpView.renterUsernameTextField.text?.count != 0  else
	{
    ...
    guard let firstName =  renterSignUpView.renterFirstNameTextField.text,  renterSignUpView.renterFirstNameTextField.text?.count != 0 else
	{
    ...
    guard let lastName = renterSignUpView.renterLastNameTextField.text, renterSignUpView.renterLastNameTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
		self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let cellPhone = renterSignUpView.renterCellPhoneTextField.text, renterSignUpView.renterCellPhoneTextField.text?.count != 0, isPhoneNumberValid(cellPhone: cellPhone) else
	{
    ...
    guard let address = renterSignUpView.renterAddressTextField.text, renterSignUpView.renterAddressTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
		fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let state = renterSignUpView.renterStateTextField.text, renterSignUpView.renterStateTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let city = renterSignUpView.renterCityTextField.text, renterSignUpView.renterCityTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let zip = renterSignUpView.renterZipcodeTextField.text, renterSignUpView.renterZipcodeTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let county = renterSignUpView.renterCountyTextField.text, renterSignUpView.renterCountyTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
