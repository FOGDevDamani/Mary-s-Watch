...
class SPSignUpController: UIViewController, UITextFieldDelegate
{
 ...
 let states = ["AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY"]
  ...
  {
    guard let typeOfService = spSignUpView.typeOfServiceTextField.text,spSignUpView.typeOfServiceTextField.text?.count != 0 else
	{
    ...
    guard let email = spSignUpView.spEmailTextField.text, spSignUpView.spEmailTextField.text?.count != 0, isValidEmail(emailID: email) != false  else
	{
    ...
    guard let password = spSignUpView.spPasswordTextField.text, spSignUpView.spPasswordTextField.text?.count != 0, isPasswordValid(password: password) != false else
	{
    ...
    guard let username = spSignUpView.spUsernameTextField.text, spSignUpView.spUsernameTextField.text?.count != 0 else
	{
    ...
    guard let firstName = spSignUpView.spFirstNameTextField.text, spSignUpView.spFirstNameTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let lastName = spSignUpView.spLastNameTextField.text, spSignUpView.spLastNameTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let cellPhone = spSignUpView.spCellPhoneTextField.text, spSignUpView.spCellPhoneTextField.text?.count != 0, isPhoneNumberValid(cellPhone: cellPhone) else
	{
    ...
    guard let address = spSignUpView.spAddressTextField.text, spSignUpView.spAddressTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let state = spSignUpView.spStateTextField.text, spSignUpView.spStateTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let city = spSignUpView.spCityTextField.text, spSignUpView.spCityTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let zip = spSignUpView.spZipcodeTextField.text, spSignUpView.spZipcodeTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    guard let county = spSignUpView.spCountyTextField.text, spSignUpView.spCountyTextField.text?.count != 0 else
	{
		let fieldMustNotBeEmptyAlert = UIAlertController(title: "Cannot skip field", message: "This field must not be left empty", preferredStyle: .alert)
      	fieldMustNotBeEmptyAlert.addAction(UIAlertAction(title: "OK", style: .default, handler: nil))
      	self.present(fieldMustNotBeEmptyAlert, animated: true, completion: nil)
    ...
    if spSignUpView.spConfirmPassword.text == spSignUpView.spPasswordTextField.text
	{
      ...
      spController.createNewSP(withEmail: email , password: password)
		...
		spController.createSPData(typeOfService: typeOfService, firstName: firstName, lastName: lastName, email: email, cellPhone: cellPhone, address: address, state: state, city: city, zip: zip, county: county, userName: username, password: password)
