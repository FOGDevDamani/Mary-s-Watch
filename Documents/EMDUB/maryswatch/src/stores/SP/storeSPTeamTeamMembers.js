...
export const useStoreSPTeamTeamMember = defineStore("storeSPTeamTeamMember", {
  ...
  actions: {
    ...
    async addSPTeamTeamMember(spTeamTeamMemberData) {
      console.log("sp team team member data", spTeamTeamMemberData);

      await addDoc(collection(db, "SPTeamTeamMembers"), {
        profileImage: spTeamTeamMemberData._value.profileImage,
        firstName: spTeamTeamMemberData._value.firstName,
        lastName: spTeamTeamMemberData._value.lastName,
        address: spTeamTeamMemberData._value.address,
        city: spTeamTeamMemberData._value.city,
        state: spTeamTeamMemberData._value.state,
        zipcode: spTeamTeamMemberData._value.zipcode,
        role: spTeamTeamMemberData._value.role,
        phone: spTeamTeamMemberData._value.phone,
        createdOn: Timestamp.now(),
        uid: this.storeAuth.user.uid,
      })
        .then(() => {
          this.storeStorage.uploadProfileImage(
            spTeamTeamMemberData._value.profileImage
          );
        })
