		...
		<form>
			<div class="row mt-4">
				<div class="col-lg-5 col-sm-8 mr-3">
					<MWFormLabelAndFileInput v-model="state.ticketImage" label="Upload Image" />
			...
			<div class="row mt-4">
				...
				<div class="col-lg-3 col-sm-4">
					<MWFormLabelAndTimePicker v-model="state.time" />
			...
			<div class="row">
				...
				<div class="col-6">
					<button type="button" @click.prevent="addRenterSupportTicket" class="btn btn-primary my-3 button">Continue</button>
				</div>
			</div>
...
<script setup>
	...
	*/
	...
	const addRenterSupportTicket = () => {
		if(renterSupportTicketData) {
			storeRenterSupportTicket.addRenterSupportTicket(state)
		}
	}
