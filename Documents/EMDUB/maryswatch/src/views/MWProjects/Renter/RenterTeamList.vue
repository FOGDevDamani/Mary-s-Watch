<template>
	<div>
		...
		<div class="ms-5 ps-1 mt-5 pt-2 row row-cols-sm-3 g-4">
			<div v-for="team in storeRenterTeam.teams" :key="team.id" class="col">
				<MWTeamCard  :profileImage="team.profileImage" :label1="team.teamName" :label2="team.address" :label3="team.teamLead" route="RenterTeamProfile" :id="team.id"></MWTeamCard>
			</div>
