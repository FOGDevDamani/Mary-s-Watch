...
export const useStoreOwnerPayment = defineStore("storeOwnerPayment", {
  ...
  actions: {
    ...
    async getPayments(currentUID) {
      ...
      await axios
        .post(
          "https://getownerpaymentlistdatafromcache-qqntzlhyfq-uw.a.run.app",
    ...
    async getPaymentDetails(docId) {
      await axios
        .post(
          "https://https://getownerpaymentdetaildatafromcache-qqntzlhyfq-uw.a.run.app",
          { id: docId }
        )
        .then((res) => {
          console.log("res", res);
    ...
    async addPayment(makeAPaymentData) {
      ...
      if (this.recentlySubmittedTicketId) {
        ...
        await axios
          .post("https://cacheownerpaymentdata-qqntzlhyfq-uw.a.run.app", {
            id: this.recentlySubmittedTicketId,
            renterTicketData: makeAPaymentData,
          })
          .then(this.router.push("/owner-payments"))
          .catch((err) => {
            console.log(err);
          });
      }
