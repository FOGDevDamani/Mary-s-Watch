		...
		<form>
			...
			<div class="row my-4">
				<div class="col-lg-5 col-sm-12">
					<MWFormLabelAndRadioInput v-model="userData.accountType" label="Choose Your Account Type" id="3"  :options="businessOrPersonalTypes"/>
			...
			<div class="row my-4" v-if="userData.userPerspective.includes('owner')"> 
				<div>
					Type of Owner:
				</div>
			...
			<div class="row mt-4" v-if="userData.userPerspective.includes('owner')">
				<div>
					Type of Company:
				</div>
...
<script setup>
	...
	*/
	const register = () => {
		const user = new User(userData.profileImage, userData.userPerspective, userData.companyType, userData.accountType, userData.bio, userData.phone, userData.licenseNumber, userData.firstName, userData.lastName, userData.address, userData.city, userData.state, userData.zipcode, userData.county, userData.username, userData.email, userData.password, userData.createdOn, userData.textOrEmail)

		if(user) {
			console.log('user from 336', user)
