...
class ServiceProvider
{
  ...
  var password: String
	...
	init(typeOfService: String, firstName: String, lastName: String, email: String, cellPhone: String, address: String, state: String, city: String, zipcode: String, county: String, username: String, password: String)
	{
	...
	convenience init?(dictionary: [String : Any])
	{
		...
		self.init(typeOfService: typeOfCompany, firstName: firstName, lastName: lastName, email: email, cellPhone: cellPhone, address: address, state: state, city: city, zipcode: zip, county: county, username: userName, password: password)
	}
  
  var dictionary:[String:Any]
  {
    return [
      "Type of Company": typeOfService,
